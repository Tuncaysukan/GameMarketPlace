...
namespace Veles\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use Veles\Scaffold\Module\Generators\FilesGenerator;
use Veles\Scaffold\Module\Generators\EntityGenerator;
...
class ModuleScaffold
{
    ...
    private function modifyComposerJsonFile(): void
    {
        ...
        foreach ($composerJsonFileAsArray as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The Veles {$moduleName} Module.\"," . PHP_EOL;
                continue;
...
JSON;
        ...
        $replace = <<<JSON
"description": "The Veles {$moduleName} Module.",
JSON;
