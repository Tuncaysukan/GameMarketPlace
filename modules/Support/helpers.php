...
if (!function_exists('is_core_module')) {
    ...
    {
        return in_array(strtolower($module), config('Veles.modules.core.config.core_modules'));
    }
}
...
if (!function_exists('veles_version')) {
    /**
     * Get the Veles version.
     *
     * @return string
     */
    function veles_version()
    {
        return Veles::VERSION;
    }
}
