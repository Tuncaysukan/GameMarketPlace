...
class Product extends Model implements Sitemapable
{
    ...
    protected static function booted(): void
    {
        ...
        static::saved(function ($product) {
            ...
            // Sadece admin panelinden veya ürün yönetimi sayfalarından geliyorsa sync işlemlerini yap
            // Sipariş işlemi sırasında bu işlemler yapılmasın
            $isAdminRequest = request()->routeIs('admin.*') ||
                            request()->routeIs('products.store') ||
                            request()->routeIs('products.update') ||
                            request()->is('*/admin/*') ||
                            (request()->hasHeader('X-Admin-Request') && request()->header('X-Admin-Request') === 'true');

            if (!empty($attributes) && $isAdminRequest) {
            ...
            // Selling price her zaman güncellenmeli (bu sipariş işlemini etkilemez)
