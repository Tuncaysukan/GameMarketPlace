<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group row">
            <label for="stock" class="col-sm-12 control-label text-left" @click="focusEditor">
                Stoklar <small>(Alt alta girin)</small>
            </label>
            ...
            <div class="col-sm-12">
                ...
                <span class="help-block text-red" v-if="errors.has('stock')" v-text="errors.get('stock')"></span>
            </div>
        </div>
    </div>
</div>
