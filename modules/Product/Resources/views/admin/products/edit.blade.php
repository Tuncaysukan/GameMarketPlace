...
@push('globals')
    <script>
        Veles.data['product'] = {!! $product_resource !!};
        Veles.data['attribute-sets'] = @json($attributeSets);
        Veles.langs['product::products.section.order_saved'] = '{{ trans('product::products.section.order_saved') }}';
        Veles.langs['product::products.variants.variants'] = '{{ trans('product::products.variants.variants') }}';
        Veles.langs['product::products.variants.variant'] = '{{ trans('product::products.variants.variant') }}';
        Veles.langs['product::products.variants.bulk_variants_updated'] = '{{ trans('product::products.variants.bulk_variants_updated') }}';
        Veles.langs['product::products.variants.variants_created'] = '{{ trans('product::products.variants.variants_created') }}';
        Veles.langs['product::products.variants.variants_removed'] = '{{ trans('product::products.variants.variants_removed') }}';
        Veles.langs['product::products.variants.variants_reordered'] = '{{ trans('product::products.variants.variants_reordered') }}';
        Veles.langs['product::products.variants.disable_default_variant'] = '{{ trans('product::products.variants.disable_default_variant') }}';
        Veles.langs['product::products.options.option_inserted'] = '{{ trans('product::products.options.option_inserted') }}';
    </script>
