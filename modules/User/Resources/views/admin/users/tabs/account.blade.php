<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::number('reference_percentage', 'Referans Komisyonu (%)', $errors, $user, ['required' => true]) }}
        {{ Form::number('balance', trans('user::attributes.users.balance'), $errors, $user, ['required' => true]) }}
