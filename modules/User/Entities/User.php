...
class User extends EloquentUser implements AuthenticatableContract
{
    ...
    protected $casts = [
        ...
        'last_login' => 'datetime',
        'is_vendor' => 'boolean',
        'vendor_application_pending' => 'boolean',
    ];
    ...
    /**
     * Get the vendor profile of the user.
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne
     */
    public function vendor()
    {
        return $this->hasOne('Modules\Vendor\Entities\Vendor');
    }
    ...
    {
        return $this->is_vendor && $this->vendor()->exists();
    }
