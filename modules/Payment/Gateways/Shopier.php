...
class Shopier implements GatewayInterface
{
    public $label;
    public $description;
    ...
    {
        $this->label = setting('shopier_label');
        $this->description = setting('shopier_description');
    }
    ...
    public function purchase(Order $order, Request $request)
    {
        ...
        throw new Exception("Doğru api bilgileri giriniz.");
