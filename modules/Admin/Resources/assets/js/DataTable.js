...
Veles.dataTable = { routes: {}, selected: {} };
...
export default class {
    constructor(selector, options, callback) {
        ...
        if (Veles.dataTable.selected[selector] === undefined) {
            Veles.dataTable.selected[selector] = [];
        }
    ...
    appendToSelected(id) {
        ...
        if (!Veles.dataTable.selected[this.selector].includes(id)) {
            Veles.dataTable.selected[this.selector].push(id);
        }
    }
    ...
    removeFromSelected(id) {
        ...
        Veles.dataTable.selected[this.selector].remove(id);
    }
    ...
    route(name, params) {
        let router = Veles.dataTable.routes[this.selector][name];
    ...
    hasRoute(name) {
        return Veles.dataTable.routes[this.selector][name] !== undefined;
    }

    static setRoutes(selector, routes) {
        Veles.dataTable.routes[selector] = routes;
    }

    static setSelectedIds(selector, selected) {
        Veles.dataTable.selected[selector] = selected;
    }

    static getSelectedIds(selector) {
        return Veles.dataTable.selected[selector];
    }
