...
$(function () {
    ...
    if (o.sidebarPushMenu) {
        $.Veles.pushMenu.activate(o.sidebarToggleSelector);
    }
...
function _init() {
    ...
    $.Veles.pushMenu = {
        activate: function (toggleBtn) {
            var screenSizes = $.Veles.options.screenSizes;
    ...
    // Tree
    $.Veles.tree = function (menu) {
        var animationSpeed = $.Veles.options.animationSpeed;
