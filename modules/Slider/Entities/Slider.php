...
class Slider extends Model
{
     ...
     * @var array
     */
    protected $with = ['translations', 'slides', 'desktopBackgroundFile', 'mobileBackgroundFile'];
    /**
     * The attributes that are mass assignable.
     *
     * @var array
     */
    protected $fillable = ['speed', 'autoplay', 'autoplay_speed', 'fade', 'dots', 'arrows', 'desktop_background_file_id', 'mobile_background_file_id'];
    ...
    public function desktopBackgroundFile()
    {
        return $this->belongsTo(File::class, 'desktop_background_file_id')->withDefault();
    }

    public function mobileBackgroundFile()
    {
        return $this->belongsTo(File::class, 'mobile_background_file_id')->withDefault();
    }
