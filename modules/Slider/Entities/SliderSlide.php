...
class SliderSlide extends Model
{
     ...
     * @var array
     */
    protected $with = ['translations', 'file', 'mobileFile', 'logoFile'];
    /**
    ...
    {
        return $this->belongsTo(File::class, 'mobile_file_id')->withDefault();
    }

    public function logoFile()
    {
        return $this->belongsTo(File::class, 'logo_file_id')->withDefault();
    }
}
