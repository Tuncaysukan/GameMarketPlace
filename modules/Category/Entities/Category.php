...
class Category extends Model implements Sitemapable
{
    ...
    {
        return $this->files->where('pivot.zone', 'category_image')->first() ?: new File;
    }
    ...
    public function toArray()
    {
        ...
        if ($this->relationLoaded('files')) {
            $attributes += [
                ...
                'category_image' => [
                    'id' => $this->category_image->id,
                    'path' => $this->category_image->path,
                    'exists' => $this->category_image->exists,
                ],
            ];
        }
