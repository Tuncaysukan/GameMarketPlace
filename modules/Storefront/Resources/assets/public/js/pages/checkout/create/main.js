    ...
    ({
        ...
        init() {
            ...
            this.$nextTick(() => {
                ...
                if (
                    Veles.stripeEnabled &&
                    Veles.stripeIntegrationType === "embedded_form"
                ) {
        ...
        async renderStripeElements() {
            this.stripe = Stripe(Veles.stripePublishableKey, {});

            this.stripeElements = this.stripe.elements({
                mode: "payment",
                amount: Math.round(this.$store.state.cartTotal * 100),
                currency: Veles.currency.toLowerCase(),
            });
        ...
        confirmFlutterWavePayment({
            ...
            FlutterwaveCheckout({
                ...
                customizations: {
                    title: Veles.storeName,
                    logo: Veles.storeLogo,
                },
                onclose(incomplete) {
                    vm.placingOrder = false;
