...
@push('globals')
    <script>
        Veles.stripePublishableKey = '{{ setting("stripe_publishable_key") }}',
        Veles.stripeEnabled = {{ setting("stripe_enabled") ? 'true' : 'false' }},
        Veles.stripeIntegrationType = '{{ setting("stripe_integration_type") }}',
        Veles.langs['storefront::checkout.payment_for_order'] = '{{ trans("storefront::checkout.payment_for_order") }}';
    </script>
