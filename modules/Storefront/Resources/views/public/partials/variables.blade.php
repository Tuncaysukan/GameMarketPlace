<style>
    :root {
        ...
        --color-primary-rgb: {{ tinycolor($themeColor->toString())->toRgbString() }};
        --color-primary-r: {{ tinycolor($themeColor->toString())->toRgb()['r'] }};
        --color-primary-g: {{ tinycolor($themeColor->toString())->toRgb()['g'] }};
        --color-primary-b: {{ tinycolor($themeColor->toString())->toRgb()['b'] }};
