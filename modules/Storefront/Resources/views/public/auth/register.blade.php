                ...
                <div class="auth-form">
                    ...
                    <form class="auth-form-body" method="POST" action="{{ route('register.post') }}">
                        ...
                        <div>
                            ...
                            <input type="hidden" name="reference" value="{{ $request->reference ?? '0' }}">
                            ...
                            <div class="form-group">
                                <label 
                                    ...
                                    class="input-label" 
                                >
                                {{ trans('storefront::layouts.username') }} <span>*</span>
                                </label>
                                ...
                                >
                                    <input 
                                        ...
                                        class="form-control"
                                        id="username"
                                        placeholder="{{ trans('storefront::layouts.type_username') }}"
                                        maxlength="16"
                                        pattern="[a-z0-9]+"
                                ...
                                {!! $errors->first('username', '<span class="help-block text-red">:message</span>') !!}
                            </div>
