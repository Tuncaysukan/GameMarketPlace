...
@section('content')
    ...
    @if (setting('storefront_product_tabs_3_section_enabled'))
        @include('storefront::public.home.sections.product_tabs_three')
    @endif

    @if (setting('storefront_product_tabs_4_section_enabled'))
        @include('storefront::public.home.sections.product_tabs_four')
    @endif

    @if (setting('storefront_product_tabs_5_section_enabled'))
        @include('storefront::public.home.sections.product_tabs_five')
    @endif

    @if (setting('storefront_product_tabs_6_section_enabled'))
        @include('storefront::public.home.sections.product_tabs_six')
    @endif

    @if (setting('storefront_product_tabs_7_section_enabled'))
        @include('storefront::public.home.sections.product_tabs_seven')
    @endif

    @if (setting('storefront_product_tabs_8_section_enabled'))
        @include('storefront::public.home.sections.product_tabs_eight')
    @endif

    @if (setting('storefront_product_tabs_9_section_enabled'))
        @include('storefront::public.home.sections.product_tabs_nine')
    @endif

    @if (setting('storefront_product_tabs_10_section_enabled'))
        @include('storefront::public.home.sections.product_tabs_ten')
    @endif
