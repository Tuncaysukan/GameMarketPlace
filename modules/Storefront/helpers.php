...
if (!function_exists('mega_menu_classes')) {
    function mega_menu_classes(Menu $menu, $type = 'category_menu')
    {
        ...
        if ($menu->isAllCategoriesMenu()) {
            array_push($classes, 'all-categories-menu');
        } else if ($menu->isFluid()) {
...
if (!function_exists('font_url')) {
    ...
    function font_url($font)
    {
        return match ($font) {
            ...
            'Manrope' => 'https://fonts.googleapis.com/css2?family=Manrope:wght@300;400;500&display=swap',
            'Ubuntu' => 'https://fonts.googleapis.com/css2?family=Ubuntu:wght@300;400;500&display=swap',
            'Lato' => 'https://fonts.googleapis.com/css2?family=Lato:wght@300;400;500&display=swap',
            'Noto Sans' => 'https://fonts.googleapis.com/css2?family=Noto+Sans:wght@300;400;500&display=swap',
        };
    }
}
