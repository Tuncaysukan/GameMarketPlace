<div class="order-information-wrapper">
    ...
    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-10 col-sm-10">
                                            <div  style="display:flex">
                                                <?php
                                                    ...
                                                    if ($order->stock_code) {
                                                        $codes = json_decode($order->stock_code, true);
                                                ...
                                                ?>
                                                <input type="text" style="border-radius: 6px 0px 0px 6px!important; font-size: 13px" class="form-control" id="teslimat_kodu" placeholder="kod1, kod2 şeklinde giriniz." value="{{ $codes }}" >
                                                <button class="btn btn-primary btn-place-order" style="border-radius: 0px 6px 6px 0px!important; background-color: #000FD0" type="button" id="teslimet">Kaydet</button>
                                            </div>
                                        </div>
                                    </div>
                                </td>
        ...
        <script>
                                $("#teslimet").click(function(e) {

                                    $.ajax({
                                        type: "PUT",
                                        url: "<?=route("admin.orders.status.update", ["order" => $order->id])?>",
                                        data: {
                                            code: $("#teslimat_kodu").val()
                                        },
                                        success: (message) => {
                                            success(message);
                                        },
